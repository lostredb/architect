...
export default function SignIn() {
    ...
    const form = useForm({
        ...
        onSubmit: async ({ value }) => {
            const parsed = userSchema.partial({name: true}).parse(value)
    ...
    return (
        <div className="flex w-full h-screen justify-center items-center">
            ...
            >
                <h1 className="text-center font-medium mb-2 tracking-[2px]">SIGN IN ACCOUNT</h1>
                <Field 
                name="email"
                children={(f) => (
                ...
                />
                <button type="submit" className="bg-[#333333] text-white text-[12px] tracking-[4px] py-3">SIGN IN</button>
            </form>
        </div>
    )
}